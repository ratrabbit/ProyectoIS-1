...
public class DatosUsuario implements java.io.Serializable {
    ...
    //método que estoy usando
    public DatosUsuario(int idDatosUsuario,Usuario usuario,String nombre,String apellidoPaterno, String apellidoMaterno ,String email, String telefono, int edad, String sexo) {
        this.idDatosUsuario = idDatosUsuario;
        this.usuario = usuario;
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
